...
model { 
  ...
  target += normal_lpdf(b_muType1MI | 0, 1); 
  target += normal_lpdf(temp_muType1MI_Intercept | 0, 4); 
  target += normal_lpdf(b_muType2MI | 0, 1); 
  target += normal_lpdf(temp_muType2MI_Intercept | 0, 4); 
